...
locals {
  ...
  scale_encryption_admin_password = var.scale_encryption_enabled && var.scale_encryption_type == "gklm" ? jsonencode(var.scale_encryption_admin_password) : jsonencode("None")
}
